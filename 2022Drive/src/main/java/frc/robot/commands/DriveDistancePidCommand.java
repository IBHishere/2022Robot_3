...
public class DriveDistancePidCommand extends PIDCommand {
  ...
  public DriveDistancePidCommand( DriveTrainSubsystem driveTrainSubsystem, double distanceToDrive) {
    super(
        ...
        driveTrainSubsystem.getPosition()+distanceToDrive,
    ...
    this.table.getEntry("distanceToDrive").setDouble(distanceToDrive);
    this.table.getEntry("computedSetPoint").setDouble(driveTrainSubsystem.getPosition()+distanceToDrive);
